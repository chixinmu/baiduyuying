...
TTS_AK = 'DYGhXNnRUwD2TQyL3b8XYDM8'
TTS_SK = 'qM36yNKGqODW0eufxHBIQx7w23pRVrpu'
...
def get_token_from_baidu():
    ...
    payload = { 'grant_type':'client_credentials',
                'client_id':'DYGhXNnRUwD2TQyL3b8XYDM8',
                'client_secret':'qM36yNKGqODW0eufxHBIQx7w23pRVrpu'
                }
